...
class _NewHomeState extends State<NewHome> {
  ...
  createIdentifierDialog(BuildContext context) {
                  ...
                  onPressed: () async {
                    if (_formKey.currentState!.validate() == true) {
                      ...
                      if (await free100Scrap.loadWebPage('$free100Url')) {
                        ...
                        times.replaceRange(6, 9,
                            [free100MTime, '100 Freestyle', free100YTime]);
                      }
                      ...
                      if (await free200Scrap.loadWebPage('$free200Url')) {
                        ...
                        times.replaceRange(9, 12,
                            [free200MTime, '200 Freestyle', free200YTime]);
                      }
                      ...
                      if (await fly100Scrap.loadWebPage('$fly100Url')) {
                        ...
                        times.replaceRange(33, 36,
                            [fly100MTime, '100 Butterfly', fly100YTime]);
                      }
                      ...
                      if (await fly200Scrap.loadWebPage('$fly200Url')) {
                        ...
                        times.replaceRange(36, 39,
                            [fly200MTime, '200 Butterfly', fly200YTime]);
                      }
                      ...
                      try {
                        ...
                        // List<String> startupList =
                        //     swimmerList.map((i) => i.toString()).toList();
                        // prefs.setStringList("startupList", startupList);
...
//created global key, needed for form
  ...
  createShareSwimmerDialog(context, swimmer) {
    return showDialog(
      context: context,
      builder: (context) {
        return AlertDialog(
  ...
  // //   List startupList = (prefs.getStringList('startupList') ?? []);
  // //   swimmerList = startupList.map((i) => ).toList();
  // // }

  @override
  Widget build(context) {
    // choose add method menu
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextButton(
                        onPressed: () {
                          Navigator.pop(context);
                          createIdentifierDialog(context);
                        },
                        child: Text('Add By Identifier'),
                        style: ButtonStyle(
                            backgroundColor: MaterialStateProperty.all<Color>(
                                Colors.blue[50]!))),
                  ],
